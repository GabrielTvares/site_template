...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const whatsappMessage = `Olá! Gostaria de conhecer o Turbineduca.\n\nNome: ${formData.name}\nE-mail: ${formData.email}\nEmpresa: ${formData.company}\nMensagem: ${formData.message}`;
  ...
  return (
  <section id="contato" className="py-12 sm:py-20 bg-gradient-to-b from-background to-slate-dark/20 relative overflow-hidden" ref={ref}>
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-[#C4D7E0] text-lg max-w-2xl mx-auto">
            Venha conhecer o Turbineduca para transformar sua gestão empresarial.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {/* Contact Form */}
          <motion.div 
            className="glass-effect p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-slate-dark/70 to-slate-premium/50 backdrop-blur-md border border-gold/20 hover:border-gold/30 transition-all duration-300"
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  required
                  className="w-full bg-slate-dark/50 border-gold/20 focus:border-gold"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  required
                  className="bg-slate-dark/50 border-gold/20 focus:border-gold"
                />
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  className="w-full bg-slate-dark/50 border-gold/20 focus:border-gold min-h-[120px]"
                />
              </div>
          ...
          >
            <div className="glass-effect p-6 rounded-xl bg-gradient-to-br from-slate-dark/70 to-slate-premium/50 backdrop-blur-md border border-gold/20">
